...
These names describe the current deployment. Use parameters for new
environments rather than copying identifiers from ignored local files.
...
| Publisher image | `ttc-digital-twin-publisher:20260814.2` |
| Publisher size | 0.5 CPU and 1 GiB |
| Publisher scale | One minimum and one maximum replica |
| Rayfin app | [TTC Digital Twin][fabric-app] |
| Publisher health | [Health endpoint][publisher-health] |
